...
namespace MaroonVillage.Core.Repositories
{
    ...
    {
        protected static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["MaroonVillageDb"].ConnectionString;
        ...
        #region Reused Data Access Methods for Compatibility with old code
        ...
        #region Data Property Parsing Methods
        ...
        /// <returns></returns>
        public bool ParseBoolean(object valuetoParse)
        {
            return ParseBoolean(valuetoParse == null || valuetoParse == DBNull.Value
                             ? string.Empty
                             : Convert.ToString(valuetoParse));
        }
        ...
        /// </summary>
        private static class SqlHelperParameterCache
        {
